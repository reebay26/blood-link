              ...
              <div class="card-body">
                <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
                  <div class="mb-3 mb-sm-0">
                    <h5 class="card-title fw-semibold">Recipient Appointments</h5>
                  </div>
         <a href="/recipient_appointments"  style="background-color: rgb(216, 26, 26); color:white" class="btn" >View Appointments Details</a>
                </div>
                <ul class="timeline-widget list-unstyled mb-0">
          @foreach($recipientappointment as $r_appointment)
            <li class="timeline-item d-flex align-items-center mb-4">
              <div class="icon-wrap me-3">
                <i class="fas fa-calendar-check"></i>
              </div>
              <div>
                <h6 class="mb-1">{{ $r_appointment->recipient_name}} booked an appointment</h6>
                <small class="text-muted">{{ $r_appointment->recipient_email }}</small>
              </div>
            </li>
          @endforeach
        </ul>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <div class="mb-4">
                  <h5 class="card-title fw-semibold">Booked Appointments</h5>
                </div>
          ...
          <div class="col-lg-8 d-flex align-items-stretch">
            <div class="card w-100">
              <div class="card-body p-4">
                <h5 class="card-title fw-semibold mb-4">Recipients Data</h5>
                  ...
                  <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                      <tr>
                        ...
                        <th class="border-bottom-0">
                          <h6 class="fw-semibold mb-0">Recipient</h6>
                        </th>
                        <th class="border-bottom-0">
                      ...
                      <tr>
                        ...
                        <td class="border-bottom-0">
                          <div class="d-flex align-items-center gap-2">
                            <span style="background-color:rgb(216, 26, 26) ;" class="badge rounded-3 fw-semibold">{{$receipt->rtype}}</span>
                          </div>
                        </td>
                        <td class="border-bottom-0">
