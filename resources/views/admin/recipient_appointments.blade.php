    ...
    <div class="no-events">
        <p>Stay tuned for more upcoming events!</p>
          ...
          <div class="col-lg-8 d-flex align-itemstext-nowrap">
            <div class="w-100">
              <div class=" p-4">
                <h5 class="card-title fw-semibold mb-4">Recipient Appointment Details</h5>
                <div class="">
                  <table class="table table-bordered table-striped text-nowrap mb-0 align-middle">
                    ...
                    <tbody>
                        @foreach( $r_appointmentdetails as $details )
                      <tr>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->recipient_name}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->recipient_email}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->recipient_phone}}</td>
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->recipient_gender}}</td>
                        ...
                        <td class="border-bottom-0 mb-0 fw-bold">{{$details->recipient_dob}}</td>
